...
# add by CAI
def detect_HeatMap(score_map, geo_map, timer, scale = 4, score_map_thresh=0.8, box_thresh=0.1, nms_thres=0.2):
    '''
    restore text boxes from score map and geo map
    :param score_map:
    :param geo_map:
    ...
    heat_map = np.clip(255 * heat_map, 0, 255).astype(np.uint8)
