...
def model(images, weight_decay=1e-5, is_training=True):
    ...
    with tf.variable_scope('feature_fusion', values=[end_points.values]):
        ...
        with slim.arg_scope([slim.conv2d],
            ...
            weight_list = []
            for weight_name in ['feature_fusion/Conv_23/weights:0', 'feature_fusion/Conv_27/weights:0', 'feature_fusion/Conv_31/weights:0']:
                weight_list.append([v for v in tf.trainable_variables() if v.name == weight_name][0])

    return F_score, F_geometry, output32, weight_list
